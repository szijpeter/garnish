...
6. Publish your public key to a supported keyserver (for example `keyserver.ubuntu.com`).
...
- `SIGNING_KEY_ID` (optional, recommended for deterministic key selection)
...
gh secret set SIGNING_KEY_ID -R szijpeter/garnish
```

## Release Mode

Current default is automatic publish+release from CI.

- Workflow: [`.github/workflows/publish.yml`](../.github/workflows/publish.yml)
- Default input: `release_mode=publish-and-release`
- Optional fallback: `release_mode=publish-only`

## First Stable Release

Released: `0.1.0` on 2026-02-27 (workflow run: <https://github.com/szijpeter/garnish/actions/runs/22489329456>).
...
4. Verify deployment status in the workflow logs and Central Portal.
5. Verify coordinates resolve from Maven Central.
